...
transformation_bq__dash__bq = SuperKubernetesPodOperator(
    ...
    cmds=["/bin/bash", "-c"],
    arguments=[get_entrypoint_cmd(r"""python3 /opt/bumblebee/main.py """)],
    name="bq-bq",
    task_id="bq-bq",
    get_logs=True,
    dag=dag,
...
hook_transporter = SuperKubernetesPodOperator(
    ...
    cmds=["/bin/sh", "-c"],
    arguments=[get_entrypoint_cmd(r"""java -cp /opt/transporter/transporter.jar:/opt/transporter/jolokia-jvm-agent.jar -javaagent:jolokia-jvm-agent.jar=port=7777,host=0.0.0.0 com.gojek.transporter.Main """)],
