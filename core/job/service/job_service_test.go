...
func TestJobService(t *testing.T) {
	...
	t.Run("Add", func(t *testing.T) {
		t.Run("add jobs", func(t *testing.T) {
			...
			jobService := service.NewJobService(jobRepo, pluginService, upstreamResolver, tenantDetailsGetter, log, eventHandler)
	...
	t.Run("Validate", func(t *testing.T) {
		t.Run("returns error when get tenant details if failed", func(t *testing.T) {
			...
			jobService := service.NewJobService(nil, nil, nil, tenantDetailsGetter, log, nil)
		...
		t.Run("returns error when generate jobs", func(t *testing.T) {
			...
			jobService := service.NewJobService(nil, pluginService, upstreamResolver, tenantDetailsGetter, log, nil)
		...
		t.Run("returns error when get all by project name failed", func(t *testing.T) {
			...
			jobService := service.NewJobService(repo, pluginService, upstreamResolver, tenantDetailsGetter, log, nil)
			err := jobService.Validate(ctx, sampleTenant, specs, logWriter)
			assert.Error(t, err)
		...
		t.Run("returns error when there's a cyclic without resource destination", func(t *testing.T) {
			...
			repo.On("GetAllByProjectName", ctx, sampleTenant.ProjectName()).Return([]*job.Job{jobA, jobB}, nil)
