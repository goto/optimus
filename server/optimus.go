...
func (s *OptimusServer) setupHandlers() error {
	...
	newJobSLAPredictorService := schedulerService.NewJobSLAPredictorService(s.logger, jobLineageService, newDurationEstimatorService, jobProviderRepo, alertsHandler)
