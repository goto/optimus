...
func TestParseTopLevelUpstreamsFromQuery(t *testing.T) {
	t.Run("parse test", func(t *testing.T) {
		testCases := []struct {
			Name                 string
			InputQuery           string
			ExpectedResourceURNs []job.ResourceURN
		}{
			{
				Name:       "simple query",
				InputQuery: "select * from data-engineering.testing.table1",
				ExpectedResourceURNs: []job.ResourceURN{
					"bigquery://data-engineering:testing.table1",
				},
			},
			{
				...
				ExpectedResourceURNs: []job.ResourceURN{
					"bigquery://data-engineering:testing.table_name-1",
				},
			},
			{
			...
			},
			{
				...
				ExpectedResourceURNs: []job.ResourceURN{
					"bigquery://data-engineering:testing.table1",
					"bigquery://data-engineering:testing.table2",
				},
			},
			{
			...
			},
			{
				...
				ExpectedResourceURNs: []job.ResourceURN{
					"bigquery://data-engineering:testing.orders",
				},
			},
			{
				...
				ExpectedResourceURNs: []job.ResourceURN{
					"bigquery://data-engineering:testing.data",
				},
			},
			{
			...
			},
			{
				...
				ExpectedResourceURNs: []job.ResourceURN{
					"bigquery://project:fire.fly",
					"bigquery://project:maximum.overdrive",
					// "bigquery://project:maximum.overdrive", // the result should be unique(?)
				},
			},
			{
			...
			},
			{
				...
				InputQuery: `
					...
					`,
				ExpectedResourceURNs: []job.ResourceURN{
					"bigquery://data-engineering:testing.an_upstream_table",
				},
			},
			{
			...
			},
			{
				...
				InputQuery: `
					...
					`,
				ExpectedResourceURNs: []job.ResourceURN{
					"bigquery://data-engineering:testing.tableABC",
				},
			},
			{
			...
			},
			{
				...
				InputQuery: `
					...
					`,
				ExpectedResourceURNs: []job.ResourceURN{
					"bigquery://data-engineering:testing.tableDEF",
				},
			},
			{
			...
			},
			{
				...
				InputQuery: `
					...
					`,
				ExpectedResourceURNs: []job.ResourceURN{
					"bigquery://data-engineering:testing.tableA*",
					"bigquery://data-engineering:testing.tableB*",
				},
			},
			{
				...
				`,
				ExpectedResourceURNs: []job.ResourceURN{
					"bigquery://data-engineering:testing.table_a",
				},
			},
			{
				...
				*/
				...
				ExpectedResourceURNs: []job.ResourceURN{
					"bigquery://data-engineering:testing.table_a",
					"bigquery://data-engineering:testing.table_d",
				},
			},
		}
