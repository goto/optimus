...
func request_JobRunService_TriggerPotentialSLABreach_0(ctx context.Context, marshaler runtime.Marshaler, client JobRunServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq TriggerPotentialSLABreachRequest
	var metadata runtime.ServerMetadata
	...
	msg, err := client.TriggerPotentialSLABreach(ctx, &protoReq, grpc.Header(&metadata.HeaderMD), grpc.Trailer(&metadata.TrailerMD))
	return msg, metadata, err

}

func local_request_JobRunService_TriggerPotentialSLABreach_0(ctx context.Context, marshaler runtime.Marshaler, server JobRunServiceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq TriggerPotentialSLABreachRequest
	var metadata runtime.ServerMetadata
	...
	msg, err := server.TriggerPotentialSLABreach(ctx, &protoReq)
	return msg, metadata, err
...
func RegisterJobRunServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server JobRunServiceServer) error {
	...
	mux.Handle("POST", pattern_JobRunService_TriggerPotentialSLABreach_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateIncomingContext(ctx, mux, req, "/gotocompany.optimus.core.v1beta1.JobRunService/TriggerPotentialSLABreach", runtime.WithHTTPPathPattern("/v1beta1/project/{project_name}/potential_sla_breach/trigger"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_JobRunService_TriggerPotentialSLABreach_0(rctx, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
		...
		forward_JobRunService_TriggerPotentialSLABreach_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterJobRunServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client JobRunServiceClient) error {
	...
	mux.Handle("POST", pattern_JobRunService_TriggerPotentialSLABreach_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateContext(ctx, mux, req, "/gotocompany.optimus.core.v1beta1.JobRunService/TriggerPotentialSLABreach", runtime.WithHTTPPathPattern("/v1beta1/project/{project_name}/potential_sla_breach/trigger"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_JobRunService_TriggerPotentialSLABreach_0(rctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
...
var (
	...
	pattern_JobRunService_TriggerPotentialSLABreach_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 4, 1, 5, 2, 2, 3, 2, 4}, []string{"v1beta1", "project", "project_name", "potential_sla_breach", "trigger"}, ""))
)
...
var (
	...
	forward_JobRunService_TriggerPotentialSLABreach_0 = runtime.ForwardResponseMessage
)
