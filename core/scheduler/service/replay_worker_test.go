...
func TestReplayWorker(t *testing.T) {
	...
	replayConfig := scheduler.NewReplayConfig(startTime, endTime, false, replayJobConfig, replayDescription, "", "approval_id", "user_id")
	replayConfigParallel := scheduler.NewReplayConfig(startTime, endTime, true, replayJobConfig, replayDescription, "", "approval_id", "user_id")
